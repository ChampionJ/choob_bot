...
import BaseSimpleCommand, { GlobalChoobCommand } from "../structures/commands/BaseSimpleCommand";
import { TwitchCustomCommand, TwitchCustomCommandModel, TwitchGlobalSimpleCommand, TwitchGlobalSimpleCommandModel } from "../structures/databaseTypes/schemas/SimpleCommand";
...
export class TwitchManager extends ChatClient {
  ...
  constructor(authProvider: AuthProvider | undefined, options?: any | undefined) {
    ...
    StateManager.on('botInChatUpdate', (name, join) => { this.onBotInChatUpdate(name, join) });
